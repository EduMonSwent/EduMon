...
You qualified for a Black Belt 🥋⚫ and got a final grade of 5.91/6 for M1. Fantastic! You've demonstrated true mastery. 
...
|---------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, CI, tests)** | 5.78 out of 6 | 40%        | [See Details](#implementation-apk-ci-tests) |
...
- The line coverage on M1 code is 92,8
- Make sure to follow one single template for commit and PR naming.

- Also, for a perfect grade, try to aim for 95% of line coverage ! (But we're already very happy with the work you did !)

For this part, you received 5.78 points out of a maximum of 6.
...
Try to add more indications towards risk assessment (can this issue block the team ? what are the consequences if it can't be done by the end of the Sprint ? Does it rely on an API that you haven't worked with yet ? ...)
...
Your team grade for milestone M1 is 5.91. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
