...
You qualified for a Green Belt 🥋🟢 and got a final grade of 4.91/6 for M2. Great job! You're building solid foundations. 
...
|------------------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, code quality)**   | 4.66 out of 6 | 40%        | [See Details](#implementation-apk-code-quality) |
...
The app presents quite a few bugs, some even freezing the app in a blank screen. 
It also doesn't scale well with different screen sizes.
Make sure to follow consistent naming conventions (like class names for E2E tests).
Your comments in the code should all be in English.
You should not have magic values in your code.
It's good that you consistently follow the MVVM pattern.
...
Whilst you added new features, you also introduced bugs preventing us from testing them fully, or even at all sometimes.
...
Whilst your Figma looks good, it doesn't match with the current state of the app.

Also, make sure to put your architecture diagram the right way up !
...
You left in-progress user stories in the product backlog when they should've been moved to "in development". Also a couple of tags were missing in the Scrum Board.
...
You forgot to fill the Scrum documents for S4 unfortunately.
...
You didn't add enough value during S3, and S5's features were impacted by the various bugs.

For this part, you received 4.5 points out of a maximum of 6.

## Summary

Your team grade for milestone M2 is 4.91/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
