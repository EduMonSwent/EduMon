...
You qualified for a Black Belt 🥋⚫ and got a final team grade of 5.52/6 for M3. Fantastic! You've demonstrated true mastery.
...
|------------------------------------------|----------------------------------|------------|--------------------------------------------|
| **Completeness**                         | 5.25 out of 6 | 20%        | [See Details](#completeness)               |
| **Functionality**                        | 5.67 out of 6 | 20%       | [See Details](#functionality)              |
...
| **QA (Testing)**                         | 5.4 out of 6           | 20%        | [See Details](#qa-testing)                 |
| **Documentation**                        | 5.4 out of 6 | 10%       | [See Details](#documentation)              |
| **Autonomy**                             | 6 out of 6     | 5%         | [See Details](#autonomy)                   |
| **Final Team Grade**                     | **5.52 out of 6** |            |                                            |
...
Excellent job! The main issue is that different values tied to the profile are not fully synchronized across screens. Also some features weren't fully working.

For this part, you received 5.25/6.
...
The features are great, however users still can't directly add friends or see their friends actual pets on the map (only the blue one is displayed).

For this part, you received 5.67/6.
...
Your coding/commit conventions were not uniform across the team.
...
The tests rely on fixed delays, which reduces their robustness. In addition, some tests do not assert any meaningful behavior, making them ineffective.
...
Your Figma is not up-to-date with your app.

Some functions would have benefitted from being explained in more details.
...
Based on the above points, your grade for this M3 milestone is 5.52/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
