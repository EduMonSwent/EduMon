...
You qualified for a Black Belt 🥋⚫ and got a final team grade of 5.79/6 for M3. Fantastic! You've demonstrated true mastery.
...
|------------------------------------------|----------------------------------|------------|--------------------------------------------|
| **Completeness**                         | 5.85 out of 6 | 20%        | [See Details](#completeness)               |
...
| **QA (Testing)**                         | 6 out of 6           | 20%        | [See Details](#qa-testing)                 |
| **Documentation**                        | 5.7 out of 6 | 10%       | [See Details](#documentation)              |
| **Autonomy**                             | 6 out of 6     | 5%         | [See Details](#autonomy)                   |
| **Final Team Grade**                     | **5.79 out of 6** |            |                                            |
...
Excellent job! The main issue is that different values tied to the profile are not fully synchronized across screens.
...
Based on the above points, your grade for this M3 milestone is 5.79/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
