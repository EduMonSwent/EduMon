...
class PlannerScreenComposeTest {
  ...
  fun petHeader_statBarsDisplayCorrectPercentages() {
    composeTestRule.setContent { PetHeader(level = 3, onEdumonNameClick = {}) }
  ...
  fun aiRecommendationCard_buttonClickWorks() {
    ...
    composeTestRule.setContent {
      AIRecommendationCard(
          recommendationText = "Test recommendation", onActionClick = { clicked = true })
    }
  ...
  fun choiceButton_displaysTextAndRespondsToClick() {
    ...
    composeTestRule.setContent {
      ChoiceButton(text = "Test Option", isSelected = false, onClick = { clicked = true })
    }
  ...
  fun plannerGlowCard_rendersContent() {
    composeTestRule.setContent {
      PlannerGlowCard { androidx.compose.material3.Text("Test content inside glow card") }
    }
  ...
  fun priorityDropdownSection_displaysCurrentPriority() {
    composeTestRule.setContent {
      PriorityDropdownSection(priority = "Medium", onPriorityChange = {})
    }
