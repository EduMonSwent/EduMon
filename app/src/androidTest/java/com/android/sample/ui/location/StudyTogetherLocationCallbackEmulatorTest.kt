 ...
 * Firestore when needed. Some parts of this code have been generated by an LLM (ClaudeAI)
 */
...
class StudyTogetherLocationCallbackEmulatorTest {
  ...
  fun setUp() = runBlocking {
    // CRITICAL: Connect to emulator FIRST before checking if it's running
  ...
  fun locationCallback_withChooseLocation_true_usesChosenCoordinates() {
    ...
    // Verify chosen location was used - updated to match new campus status chip text
