...
object EduMonResourceRegistry {
  ...
  private val floramonAccessories: Map<AccessorySlot, Map<AccessoryType, Int>> =
      mapOf(
          AccessorySlot.HEAD to
              mapOf(
  ...
  @DrawableRes
  fun getBaseDrawable(type: EduMonType): Int =
      when (type) {
  ...
  @DrawableRes
  fun getAccessoryDrawable(eduMonType: EduMonType, slot: AccessorySlot, accessoryId: String): Int {
