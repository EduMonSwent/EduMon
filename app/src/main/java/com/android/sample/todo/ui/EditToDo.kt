...
/**
 * Screen for editing an existing To-Do.
 * It reuses the same TodoForm composable as AddToDoScreen,
 * but initializes fields with an existing ToDo (via its ID)
 * and updates the repository instead of adding a new entry.
 */
@Composable
fun EditToDoScreen(id: String, onBack: () -> Unit) {
    ...
    val vm: EditToDoViewModel = viewModel(
