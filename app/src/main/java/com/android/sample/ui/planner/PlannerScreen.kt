...
object PlannerScreenTestTags {
    ...
    const val PET_HEADER = "petHeader"
    const val TODAY_CLASSES_SECTION = "TODAY_CLASSES_SECTION"
    const val WELLNESS_CAMPUS_SECTION = "WELLNESS_CAMPUS_SECTION"
...
fun PlannerScreen(viewModel: PlannerViewModel = viewModel()) {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // Pet header connected to repository, no manual params needed
            item {
                PetHeaderConnected(
                    modifier = Modifier
                        .fillMaxWidth()
