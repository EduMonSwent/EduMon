...
class PlannerViewModel(
    private val profileRepository: PlannerRepository = PlannerRepository()
) : ViewModel() {
    ...
    val todayAttendanceRecords: StateFlow<List<ClassAttendance>> = _todayAttendanceRecords.asStateFlow()
    ...
    private fun loadTodayClasses() {
        viewModelScope.launch {
            _todayClasses.value = profileRepository.getTodayClasses()
        }
    }
