...
class EduMonResourceRegistryTest {
  ...
  fun getAccessoryDrawable_pyromonHat_returnsCorrectDrawable() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.PYROMON, AccessorySlot.HEAD, AccessoryType.HAT)
  ...
  fun getAccessoryDrawable_aquamonWings_returnsCorrectDrawable() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.AQUAMON, AccessorySlot.BACK, AccessoryType.WINGS)
  ...
  fun getAccessoryDrawable_floramonScarf_returnsCorrectDrawable() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.FLORAMON, AccessorySlot.TORSO, AccessoryType.SCARF)
  ...
  fun getAccessoryDrawable_withStringId_returnsCorrectDrawable() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.PYROMON, AccessorySlot.HEAD, AccessoryType.GLASSES.id)
  ...
  fun getAccessoryDrawable_invalidStringId_returnsNoResource() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.PYROMON, AccessorySlot.HEAD, INVALID_ID)
  ...
  fun getAccessoryDrawable_emptyStringId_returnsNoResource() {
    val result =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.PYROMON, AccessorySlot.HEAD, EMPTY_STRING)
    assertEquals(NO_RESOURCE, result)
  }
  ...
  fun getAccessoryDrawable_sameAccessory_returnsDifferentDrawablePerEduMon() {
    ...
    val aquamonHat =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.AQUAMON, AccessorySlot.HEAD, AccessoryType.HAT)
    val floramonHat =
        EduMonResourceRegistry.getAccessoryDrawable(
            EduMonType.FLORAMON, AccessorySlot.HEAD, AccessoryType.HAT)
  ...
  fun allHeadAccessories_availableForAllEduMonTypes() {
    ...
    for (eduMon in EduMonType.values()) {
      for (accessory in headAccessories) {
        val result =
            EduMonResourceRegistry.getAccessoryDrawable(eduMon, AccessorySlot.HEAD, accessory)
        assertNotEquals("Missing: $eduMon HEAD $accessory", NO_RESOURCE, result)
      }
    }
  }
  ...
  fun allTorsoAccessories_availableForAllEduMonTypes() {
    ...
    for (eduMon in EduMonType.values()) {
      for (accessory in torsoAccessories) {
        val result =
            EduMonResourceRegistry.getAccessoryDrawable(eduMon, AccessorySlot.TORSO, accessory)
        assertNotEquals("Missing: $eduMon TORSO $accessory", NO_RESOURCE, result)
      }
    }
  }
  ...
  fun allBackAccessories_availableForAllEduMonTypes() {
    ...
    for (eduMon in EduMonType.values()) {
      for (accessory in backAccessories) {
        val result =
            EduMonResourceRegistry.getAccessoryDrawable(eduMon, AccessorySlot.BACK, accessory)
        assertNotEquals("Missing: $eduMon BACK $accessory", NO_RESOURCE, result)
      }
    }
  }
}
